...
<div className="absolute inset-0 -z-10 pointer-events-none">
  ...
  />
      ...
      <div className="mt-8 flex items-center">
        <a href="#about" className="group bg-white text-black px-7 py-2.5 rounded-xl transition-all duration-300 hover:scale-105 shadow-lg shadow-white/10">          
          Resume
          <ArrowRightIcon className="ml-2 size-5 inline-flex transition-transform group-hover:translate-x-1" />
        </a>

        <a href="https://t.me/WZiet" target="_blank" rel="noopener noreferrer" className="ml-4 border border-white/20 bg-white/5 backdrop-blur-md hover:bg-white/10 text-gray-200 px-6 py-2.5 rounded-xl transition-all duration-300">
            Connect me
        </a>
      </div>
    </div>
